...
const Received = ({ visible, onClose, onProceed, report, time, respo }) => {
    ...
    return (
        ...
        >
            ...
            <View className={`w-[85%] ${height <= 900 ? 'h-[80%]' : 'h-[74%]'} bg-white items-center justify-center rounded-3xl`}>
                ...
                />
                {/* Received Title */}
                <Text className="text-primary text-2xl font-psemibold py-6" numberOfLines={1} ellipsizeMode='tail'>{'HOLD TIGHT'}</Text>
