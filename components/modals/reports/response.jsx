...
const Response = ({ visible, onClose, onProceed, onNavigate, report, id, time, user }) => {
        ...
        >
            <SafeAreaView className="items-center justify-center">
                <View className={`w-[85%] ${height <= 900 ? 'h-[80%]' : 'h-[76%]'} bg-white items-center justify-center rounded-3xl`}>
                    ...
                    />
                    {/* Received Title */}
                    <Text className="text-primary text-2xl font-psemibold py-6" numberOfLines={1} ellipsizeMode='tail'>{'REPORT RECEIVED'}</Text>
                    ...
                    <View className="w-[80%] flex-row justify-between">
                        ...
                        {/* Ok */}
                        <TouchableHighlight className="py-3 px-4 bg-primary rounded-2xl" underlayColor={"#86ebaa"} onPress={onNavigate}>
